      ...
      <div className='group box-border overflow-hidden flex rounded-md shadow-sm pe-0 flex-col items-center bg-white relative'>
        ...
        >
          <div className='left-3'>
            <Stock product={product} stock={product.quantity} card />
          </div>

          <Discount product={product} />

          {product?.galleryImages[5] ? (
            <Image
              src={product.galleryImages[5]}
              width={210}
              height={210}
              alt='product'
          ...
          <div className='flex justify-between items-center text-heading text-sm sm:text-base space-s-2 md:text-base lg:text-xl'>
            ...
            {inCart(product._id) ? (
              ...
              <button
                ...
                aria-label='cart'
                className='h-9 w-9 flex items-center justify-center border border-gray-200 rounded  text-green-500  hover:border-emerald-500 hover: bg-emerald-500  hover:text-white transition-all'
              >
                {' '}
